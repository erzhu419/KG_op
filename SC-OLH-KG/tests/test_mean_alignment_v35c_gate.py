...
SUBMIT_PATH = (
    REPO
    / "scripts/submit_scolhkg_mean_alignment_v35c_frontier_exclusion_gate_scheduler.py"
)
SUBMIT_SPEC = importlib.util.spec_from_file_location(
    "mean_v35c_submit", SUBMIT_PATH)
...
def test_v35c_keeps_terminal_recommendation_out_of_online_action_set(tmp_path):
