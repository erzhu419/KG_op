...
SUBMIT_PATH = (
    REPO / "scripts/submit_scolhkg_mean_alignment_v31_sandwich_gate_scheduler.py")
SUBMIT_SPEC = importlib.util.spec_from_file_location(
    "mean_v31_submit", SUBMIT_PATH)
...
def test_v31_submitter_pairs_local_sandwich_calibrations(tmp_path):
