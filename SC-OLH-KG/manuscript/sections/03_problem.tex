...
The source archive is an exogenously supplied input.  In the synthetic stress
test its tasks are drawn from the same registered regime as the target; in the
external study they obey the stated region-holdout rule.  The method ranks
profiles within that supplied archive.  It does not identify, retrieve, or
purchase related historical tasks from a larger repository.  Archive
retrieval is therefore an upstream decision outside the claimed algorithm.
