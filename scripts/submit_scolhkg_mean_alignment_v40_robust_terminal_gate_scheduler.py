#!/usr/bin/env python3
"""Submit the V40 robust-certificate terminal-value gate."""
...
BASE_PATH = (
    ROOT
    / "scripts/submit_scolhkg_mean_alignment_v39_signed_voi_gate_scheduler.py"
)
SPEC = importlib.util.spec_from_file_location("mean_alignment_v39_submit", BASE_PATH)
base = importlib.util.module_from_spec(SPEC)
SPEC.loader.exec_module(base)


def _robust_profile(mc_samples):
    value = dict(base.VARIANTS["v39_signed_mc2"])
    value.update({
        "exact_terminal_mode": "certified_lexicographic",
...
VARIANTS = {
    ...
    "v39_signed_bayes_mc4": dict(base.VARIANTS["v39_signed_mc4"]),
    "v40_robust_lex_mc2": _robust_profile(2),
    "v40_robust_lex_mc4": _robust_profile(4),
}
...
def build_specs(args):
    ...
    args.stage_family = "mean_v40"
    args.gate_label = "Mean V40"
...
def main():
    ...
    parser.add_argument("--run-id", default=(
        "scolh_mean_alignment_v40_robust_terminal_s1_"
