#!/usr/bin/env python3
"""Submit the V6 online hierarchical mean-calibration gate."""
...
BASE_PATH = ROOT / "scripts/submit_scolhkg_mean_alignment_v5_offline_gate_scheduler.py"
...
DEFAULT_SOURCE_RUN_ID = base.DEFAULT_SOURCE_RUN_ID


def build_specs(args):
    args.variant_profiles = VARIANTS
    args.stage_family = "mean_v6"
    args.gate_label = "Mean V6"
...
def main():
    ...
    parser.add_argument("--run-id", default=(
        "scolh_mean_alignment_v6_sequential_n20_s5_"
    ...
    if int(args.N) <= int(args.n0):
        raise ValueError("V6 sequential gate requires N > n0")
