#!/usr/bin/env python3
"""Submit the V47 random-effects deconvolution Queue gate."""
...
SPEC = importlib.util.spec_from_file_location("mean_alignment_v46_submit", BASE_PATH)
...
VARIANTS = {
    ...
    "v46_grouped_task_bayes": dict(
        base.VARIANTS["v46_grouped_task_bayes"]),
    "v47_deconvolved_task_bayes": base._profile(
        "grouped_task_deconvolved"),
    "v47_deconvolved_task_predictive_bayes": base._profile(
...
def build_specs(args):
    ...
    args.stage_family = "mean_v47"
    args.gate_label = "Mean V47"
...
def main():
    ...
    parser.add_argument("--run-id", default=(
        "scolh_mean_alignment_v47_deconvolution_"
