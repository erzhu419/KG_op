#!/usr/bin/env python3
"""Submit the V20 finite channel-role assignment posterior gate."""
...
BASE_PATH = (
    ROOT / "scripts/submit_scolhkg_mean_alignment_v19_offline_gate_scheduler.py"
)
SPEC = importlib.util.spec_from_file_location("mean_alignment_v19_submit", BASE_PATH)
base = importlib.util.module_from_spec(SPEC)
SPEC.loader.exec_module(base)


def _role_assignment(*, hierarchical=False):
    value = base.base._profile()
    value.update({
        "role_assignment_posterior": True,
        "role_assignment_prior": "uniform",
        "role_assignment_inactive_variance": 1e-12,
        "target_residual_rank": 0,
        "residual_rank_posterior": False,
        "misspecification": (
...
VARIANTS = {
    "v15_tanh_control": base.base._profile(),
    "v17_hard_intervention": base.base.base._profile(
        "role_intervention_transport"),
    "v18_rank2_fixed": base.base._profile(rank=2, prior_scale=0.25),
    "role_assignment_plain": _role_assignment(),
    "role_assignment_hierarchical": _role_assignment(hierarchical=True),
}
...
def build_specs(args):
    ...
    args.stage_family = "mean_v20"
    args.gate_label = "Mean V20"
...
def main():
    ...
    parser.add_argument("--run-id", default=(
        "scolh_mean_alignment_v20_offline_s5_"
