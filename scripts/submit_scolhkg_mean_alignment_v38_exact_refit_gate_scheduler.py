#!/usr/bin/env python3
"""Submit the V38 exact-refit evaluate-or-replicate gate."""
...
BASE_PATH = (
    ROOT
    / "scripts/submit_scolhkg_mean_alignment_v37_cluster_hc3_gate_scheduler.py"
)
SPEC = importlib.util.spec_from_file_location("mean_alignment_v37_submit", BASE_PATH)
base = importlib.util.module_from_spec(SPEC)
SPEC.loader.exec_module(base)


def _exact_profile(replicate_count):
    value = dict(base.VARIANTS[f"v37_cluster_rep{replicate_count}"])
    value.update({
...
VARIANTS = {
    ...
    "v37_cluster_rep4": dict(base.VARIANTS["v37_cluster_rep4"]),
    "v38_exact_rep4": _exact_profile(4),
    "v38_exact_rep8": _exact_profile(8),
}
...
def build_specs(args):
    ...
    args.stage_family = "mean_v38"
    args.gate_label = "Mean V38"
...
def main():
    ...
    parser.add_argument("--run-id", default=(
        "scolh_mean_alignment_v38_exact_refit_s5_"
