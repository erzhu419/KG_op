#!/usr/bin/env python3
"""Submit the V35 predictive/robust covariance authority split gate."""
...
SPEC = importlib.util.spec_from_file_location("mean_alignment_v34_submit", BASE_PATH)
base = importlib.util.module_from_spec(SPEC)
SPEC.loader.exec_module(base)


def _profile(misspecification):
    value = dict(base.VARIANTS["v29_scale_control"])
    value.update({
...
VARIANTS = {
    ...
    "v34_joint_control": _profile("predictive_scale_sandwich_hc3"),
    "v35_confidence": _profile(
        "predictive_scale_sandwich_hc3_confidence"),
    "v35_confidence_task": _profile(
...
def build_specs(args):
    ...
    args.stage_family = "mean_v35"
    args.gate_label = "Mean V35"
...
def main():
    ...
    parser.add_argument("--run-id", default=(
        "scolh_mean_alignment_v35_confidence_split_s5_"
