#!/usr/bin/env python3
"""Submit the V28 constraint-head authority separation gate."""
...
def _authority(mode):
    value = dict(base.VARIANTS["exchangeable_aggregate_none"])
    value["certification_head_authority"] = str(mode)
    return value


VARIANTS = {
    "v27_task_joint": _authority("task_joint"),
    "v28_split_task_hvd": _authority("split_gpr_task_hvd"),
    "v28_split_cumulative_hvd": _authority(
...
def build_specs(args):
    ...
    args.stage_family = "mean_v28"
    args.gate_label = "Mean V28"
...
def main():
    ...
    parser.add_argument("--run-id", default=(
        "scolh_mean_alignment_v28_authority_s5_"
