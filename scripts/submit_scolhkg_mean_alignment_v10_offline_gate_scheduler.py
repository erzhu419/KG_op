#!/usr/bin/env python3
"""Submit the V10 aggregate-transferability latent posterior gate."""
...
BASE_PATH = (
    ROOT / "scripts/submit_scolhkg_mean_alignment_v9_offline_gate_scheduler.py"
)
SPEC = importlib.util.spec_from_file_location("mean_alignment_v9_submit", BASE_PATH)
...
VARIANTS = {
    ...
    "aggregate_latent": {
        "descriptor": "role_adaptive_ordered",
        "adaptation": "sequential_aggregate_mixture",
        "misspecification": "none",
        "role_epistemic": "none",
        "hvd_task_weight": "independent",
    },
...
def build_specs(args):
    ...
    args.stage_family = "mean_v10"
    args.gate_label = "Mean V10"
    args.sequential = bool(int(args.N) > int(args.n0))
    return base.base.base.build_specs(args)


def main():
    parser = argparse.ArgumentParser()
    defaults = base.base.base
    ...
    parser.add_argument("--run-id", default=(
        "scolh_mean_alignment_v10_offline_s5_"
