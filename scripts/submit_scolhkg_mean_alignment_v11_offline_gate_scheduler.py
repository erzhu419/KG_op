#!/usr/bin/env python3
"""Submit the V11 support-adaptive aggregate-transfer gate."""
...
BASE_PATH = (
    ROOT / "scripts/submit_scolhkg_mean_alignment_v10_offline_gate_scheduler.py"
)
SPEC = importlib.util.spec_from_file_location("mean_alignment_v10_submit", BASE_PATH)
...
VARIANTS = {
    ...
    "support_adaptive_aggregate": {
        ...
        "adaptation": "sequential_support_adaptive_aggregate_mixture",
...
def build_specs(args):
    ...
    args.stage_family = "mean_v11"
    args.gate_label = "Mean V11"
    args.sequential = bool(int(args.N) > int(args.n0))
    return base.base.base.base.build_specs(args)


def main():
    parser = argparse.ArgumentParser()
    defaults = base.base.base.base
    ...
    parser.add_argument("--run-id", default=(
        "scolh_mean_alignment_v11_offline_s5_"
