#!/usr/bin/env python3
"""Submit the V42 shared-low-rank source hyperlaw gate."""
...
SPEC = importlib.util.spec_from_file_location("mean_alignment_v41_submit", BASE_PATH)
...
VARIANTS = {
    "v35_model_confidence": _profile("single_gaussian_draw", "model"),
    "v41_source_bayes": _profile("single_gaussian_draw", "source_bayes"),
    "v42_shared_low_rank_model": _profile(
        "shared_low_rank_discrepancy", "model"),
...
def build_specs(args):
    ...
    args.stage_family = "mean_v42"
    args.gate_label = "Mean V42"
...
def main():
    ...
    parser.add_argument("--run-id", default=(
        "scolh_mean_alignment_v42_shared_low_rank_s5_"
