#!/usr/bin/env python3
"""Submit the V35c terminal-frontier exclusion authority gate."""
...
def _profile(name):
    ...
    value["terminal_frontier_candidate_count"] = 0
    return value
...
def build_specs(args):
    ...
    args.stage_family = "mean_v35c"
    args.gate_label = "Mean V35c"
...
def main():
    ...
    parser.add_argument("--run-id", default=(
        "scolh_mean_alignment_v35c_frontier_exclusion_s5_"
