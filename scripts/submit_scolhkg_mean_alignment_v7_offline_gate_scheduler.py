#!/usr/bin/env python3
"""Submit the V7 role-support and source-contrast mean gate."""
...
def build_specs(args):
    ...
    args.stage_family = "mean_v7"
    args.gate_label = "Mean V7"
...
def main():
    ...
    parser.add_argument("--run-id", default=(
        "scolh_mean_alignment_v7_offline_s5_"
