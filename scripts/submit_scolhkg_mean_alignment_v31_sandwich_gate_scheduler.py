#!/usr/bin/env python3
"""Submit the V31 posterior-only local HC3 mean-calibration gate."""
...
BASE_PATH = (
    ROOT
    / "scripts/submit_scolhkg_mean_alignment_v30_student_t_gate_scheduler.py"
)
SPEC = importlib.util.spec_from_file_location("mean_alignment_v30_submit", BASE_PATH)
...
VARIANTS = {
    ...
    "v31_hc3": _profile("predictive_sandwich_hc3"),
    "v31_hc3_task": _profile("predictive_sandwich_hc3_task"),
}
...
def build_specs(args):
    ...
    args.stage_family = "mean_v31"
    args.gate_label = "Mean V31"
...
def main():
    ...
    parser.add_argument("--run-id", default=(
        "scolh_mean_alignment_v31_sandwich_s5_"
