#!/usr/bin/env python3
"""Submit the V46 within-base grouped source-task hyperlaw gate."""
...
SPEC = importlib.util.spec_from_file_location("mean_alignment_v45_submit", BASE_PATH)
base = importlib.util.module_from_spec(SPEC)
SPEC.loader.exec_module(base)


def _profile(hyperlaw_mode):
    return base._profile(
        hyperlaw_mode=hyperlaw_mode,
        augments=4,
...
VARIANTS = {
    "v41_two_task_source_bayes": dict(
        base.VARIANTS["v41_two_task_source_bayes"]),
    "v45_geometry_source_bayes": dict(
        base.VARIANTS["v45_geometry_source_bayes"]),
    "v46_grouped_task_bayes": _profile("grouped_task_discrepancy"),
    "v46_grouped_task_predictive_bayes": _profile("grouped_task_predictive"),
}
...
def build_specs(args):
    ...
    args.stage_family = "mean_v46"
    args.gate_label = "Mean V46"
...
def main():
    ...
    parser.add_argument("--run-id", default=(
        "scolh_mean_alignment_v46_grouped_hyperlaw_"
