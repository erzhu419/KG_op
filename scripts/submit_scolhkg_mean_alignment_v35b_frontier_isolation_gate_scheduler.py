#!/usr/bin/env python3
"""Submit the V35b confidence-authority frontier-isolation gate."""
...
def _profile(name):
    value = dict(base.VARIANTS[name])
    value["terminal_frontier_candidate_count"] = 1
    return value


VARIANTS = {
    "v29_scale_control": _profile("v29_scale_control"),
    "v35_confidence": _profile("v35_confidence"),
}
...
def build_specs(args):
    ...
    args.stage_family = "mean_v35b"
    args.gate_label = "Mean V35b"
...
def main():
    ...
    parser.add_argument("--run-id", default=(
        "scolh_mean_alignment_v35b_frontier_isolation_s5_"
