#!/usr/bin/env python3
"""Submit the V34 scaled-hyperlaw plus HC3 robust-posterior gate."""
...
VARIANTS = {
    ...
    "v31_hc3_control": _profile("predictive_sandwich_hc3"),
    "v34_scale_hc3": _profile("predictive_scale_sandwich_hc3"),
    "v34_scale_hc3_task": _profile(
...
def build_specs(args):
    ...
    args.stage_family = "mean_v34"
    args.gate_label = "Mean V34"
...
def main():
    ...
    parser.add_argument("--run-id", default=(
        "scolh_mean_alignment_v34_robust_eb_s5_"
