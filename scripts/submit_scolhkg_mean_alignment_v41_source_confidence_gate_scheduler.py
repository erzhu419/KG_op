#!/usr/bin/env python3
"""Submit the V41 source-conditioned confidence-sequence gate."""
...
BASE_PATH = (
    ROOT
    / "scripts/submit_scolhkg_mean_alignment_v40_robust_terminal_gate_scheduler.py"
)
SPEC = importlib.util.spec_from_file_location("mean_alignment_v40_submit", BASE_PATH)
base = importlib.util.module_from_spec(SPEC)
SPEC.loader.exec_module(base)


def _profile(confidence_mode):
    value = dict(base.VARIANTS["v35_sobol_new"])
    value.update({
...
VARIANTS = {
    "v35_model_confidence": _profile("model"),
    "v41_source_bayes": _profile("source_bayes"),
    "v41_source_self_normalized": _profile("source_self_normalized"),
}
...
def build_specs(args):
    ...
    args.stage_family = "mean_v41"
    args.gate_label = "Mean V41"
...
def main():
    ...
    parser.add_argument("--run-id", default=(
        "scolh_mean_alignment_v41_source_confidence_s5_"
