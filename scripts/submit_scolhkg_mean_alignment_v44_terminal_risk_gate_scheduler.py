#!/usr/bin/env python3
"""Submit the V44 terminal Bayes-risk penalty diagnostic."""
...
def _profile(penalty):
    value = dict(base.VARIANTS["v41_source_bayes"])
    value.update({
        "decision_risk_penalty": float(penalty),
...
VARIANTS = {
    "v41_rho5": _profile(5.0),
    "v44_rho20": _profile(20.0),
    "v44_rho80": _profile(80.0),
}
SCENARIOS = base.SENTINEL_SCENARIOS
...
def build_specs(args):
    seeds = base._parse_seeds(getattr(args, "seeds", "1,3"))
    args.variant_profiles = VARIANTS
    args.scenarios = SCENARIOS
    args.stage_family = "mean_v44"
    args.gate_label = "Mean V44"
...
def main():
    ...
    parser.add_argument("--run-id", default=(
        "scolh_mean_alignment_v44_terminal_risk_"
