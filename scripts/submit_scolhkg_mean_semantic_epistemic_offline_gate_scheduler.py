#!/usr/bin/env python3
"""Submit the V4 mean-semantics and epistemic-calibration offline gate."""
...
VARIANTS = {
    "v3_control": {
        "descriptor": "ordered",
        "feature": "linear",
        "adaptation": "evidence_mixture",
        "deviation": "raw_independent",
    },
    "semantic_invariant": {
        "descriptor": "set_invariant",
        "feature": "linear",
        "adaptation": "evidence_mixture",
        "deviation": "raw_independent",
    },
...
def _flags(profile, args):
    return [
        ...
        "--observable-mean-feature-mode", profile["feature"],
        ...
        "--source-constraint-mean-adaptation-mode", profile["adaptation"],
        "--source-constraint-mean-deviation-mode", profile["deviation"],
        ...
        for heldout, shock_scale in SCENARIOS:
            ...
            for offset in range(int(args.n_seeds)):
                ...
                command = [
                    ...
                    "--line", "lodo",
                    "--seed", str(seed),
                    "--experiment-variant", f"mean_v4_offline/{cell}",
...
def main():
    ...
    parser.add_argument("--run-id", default=(
        "scolh_mean_semantic_epistemic_offline_s5_"
