#!/usr/bin/env python3
"""Submit the V37 replicate-aware clustered-HC3 gate."""
...
SPEC = importlib.util.spec_from_file_location("mean_alignment_v36_submit", BASE_PATH)
...
VARIANTS = {
    ...
    "v36_joint_new_only": dict(base.VARIANTS["v36_joint_new_only"]),
    "v37_cluster_rep4": dict(base.VARIANTS["v36_joint_rep4"]),
    "v37_cluster_rep8": dict(base.VARIANTS["v36_joint_rep8"]),
}
...
def build_specs(args):
    ...
    args.stage_family = "mean_v37"
    args.gate_label = "Mean V37"
...
def main():
    ...
    parser.add_argument("--run-id", default=(
        "scolh_mean_alignment_v37_cluster_hc3_s5_"
